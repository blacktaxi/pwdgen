...
Elm.Blueshift = Elm.Blueshift || {};
Elm.Blueshift.make = function (_elm) {
   "use strict";
   _elm.Blueshift = _elm.Blueshift || {};
   if (_elm.Blueshift.values) return _elm.Blueshift.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var errMsgExpected = F2(function (label,inp) {
      return A2($Basics._op["++"],
      "expected ",
      A2($Basics._op["++"],label,A2($Basics._op["++"]," at or near \'",A2($Basics._op["++"],A2($String.left,5,inp),"\'"))));
   });
   var runParser = F2(function (_p0,inp) {    var _p1 = _p0;return _p1._0(inp);});
   var parse = F2(function (p,inp) {
      var _p2 = A2(runParser,p,inp);
      if (_p2.ctor === "Ok") {
            return $Result.Ok(_p2._0._0);
         } else {
            return $Result.Err(_p2._0);
         }
   });
   var Parser = function (a) {    return {ctor: "Parser",_0: a};};
   var succeed = function (x) {    return Parser(function (inp) {    return $Result.Ok({ctor: "_Tuple2",_0: x,_1: inp});});};
   var fail = function (err) {    return Parser(function (_p3) {    return $Result.Err(err);});};
   var map = F2(function (f,p) {
      return Parser(function (inp) {
         var _p4 = A2(runParser,p,inp);
         if (_p4.ctor === "Ok") {
               return $Result.Ok({ctor: "_Tuple2",_0: f(_p4._0._0),_1: _p4._0._1});
            } else {
   ...
   var andThen = F2(function (p,f) {
      return Parser(function (inp) {
         var _p5 = A2(runParser,p,inp);
         if (_p5.ctor === "Ok") {
               return A2(runParser,f(_p5._0._0),_p5._0._1);
            } else {
               return $Result.Err(_p5._0);
            }
      });
   });
   _op[">>="] = $Basics.flip(andThen);
   var followedBy = F2(function (p,q) {    return A2(andThen,p,function (_p6) {    return q;});});
   var combine = F2(function (q,w) {    return A2(andThen,q,$Basics.always(w));});
   var apply = F2(function (a,p) {    return A2(andThen,a,function (f) {    return A2(andThen,p,function (a) {    return succeed(f(a));});});});
   var or = F2(function (q,w) {
      return Parser(function (inp) {    var _p7 = A2(runParser,q,inp);if (_p7.ctor === "Ok") {    return _p7;} else {    return A2(runParser,w,inp);}});
   });
   var many = function (p) {    return A2(or,some(p),succeed(_U.list([])));};
   var some = function (p) {
      return A2(andThen,p,function (v) {    return A2(andThen,many(p),function (vs) {    return succeed(A2($List._op["::"],v,vs));});});
   };
   var end = Parser(function (inp) {
      var _p8 = inp;
      if (_p8 === "") {
            return $Result.Ok({ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: ""});
         } else {
            return $Result.Err(A2(errMsgExpected,"end of input",inp));
         }
   });
   var anyChar = Parser(function (inp) {
      var _p9 = $String.uncons(inp);
      if (_p9.ctor === "Just") {
            return $Result.Ok({ctor: "_Tuple2",_0: _p9._0._0,_1: _p9._0._1});
         } else {
            return $Result.Err(A2(errMsgExpected,"any character",inp));
         }
   });
   var satisfy = function (pred) {
      return A2(andThen,anyChar,function (c) {    return pred(c) ? succeed(c) : fail(A2($Basics._op["++"],"no sat for ",$String.fromChar(c)));});
   };
   var notChar = function (c) {    return satisfy(F2(function (x,y) {    return !_U.eq(x,y);})(c));};
   var anyOf = function (s) {    return satisfy(function (x) {    return A2($String.contains,$String.fromChar(x),s);});};
   var notAnyOf = function (s) {    return satisfy(function (x) {    return $Basics.not(A2($String.contains,$String.fromChar(x),s));});};
   var annotate = F2(function (p,label) {
      return Parser(function (inp) {
         var _p10 = A2(runParser,p,inp);
         if (_p10.ctor === "Ok") {
               return _p10;
            } else {
               return $Result.Err(A2(errMsgExpected,label,inp));
            }
      });
   });
   var $char = function (c) {
      return A2(annotate,satisfy(F2(function (x,y) {    return _U.eq(x,y);})(c)),A2($Basics._op["++"],"\'",A2($Basics._op["++"],$String.fromChar(c),"\'")));
   };
   var string = function (s) {
      var p = Parser(function (inp) {
         return _U.eq(A2($String.left,$String.length(s),inp),s) ? $Result.Ok({ctor: "_Tuple2"
                                                                             ,_0: s
                                                                             ,_1: A2($String.dropLeft,$String.length(s),inp)}) : $Result.Err("");
      });
      return A2(annotate,p,A2($Basics._op["++"],"\'",A2($Basics._op["++"],s,"\'")));
   };
   return _elm.Blueshift.values = {_op: _op
                                  ,Parser: Parser
                                  ,runParser: runParser
                                  ,parse: parse
                                  ,succeed: succeed
...
Elm.SecureRandom = Elm.SecureRandom || {};
Elm.SecureRandom.make = function (_elm) {
   "use strict";
   _elm.SecureRandom = _elm.SecureRandom || {};
   if (_elm.SecureRandom.values) return _elm.SecureRandom.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$SecureRandom = Elm.Native.SecureRandom.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var maxUint32 = Math.pow(2,32) - 1;
   var compressFloat = F3(function (from,to,x) {    return from + (to - from) * ($Basics.toFloat(x) / $Basics.toFloat(maxUint32));});
   var compressInt = F3(function (from,to,x) {    return A2($Basics._op["%"],x,to - from + 1) + from;});
   var floats = F3(function (from,to,n) {
      return A2($Task.map,$List.map(A2(compressFloat,from,to)),$Native$SecureRandom.getRandomInts(A2($Basics.min,0,n)));
   });
   var $float = F2(function (from,to) {    return A2($Task.map,A2(compressFloat,from,to),$Native$SecureRandom.getRandomInt({ctor: "_Tuple0"}));});
   var bools = function (n) {
      return A2($Task.map,$List.map(function (x) {    return _U.eq(A2($Basics._op["%"],x,2),0);}),$Native$SecureRandom.getRandomInts(A2($Basics.min,0,n)));
   };
   var bool = A2($Task.map,function (x) {    return _U.eq(A2($Basics._op["%"],x,2),0);},$Native$SecureRandom.getRandomInt({ctor: "_Tuple0"}));
   var ints = F3(function (from,to,n) {    return A2($Task.map,$List.map(A2(compressInt,from,to)),$Native$SecureRandom.getRandomInts(A2($Basics.min,0,n)));});
   var $int = F2(function (from,to) {    return A2($Task.map,A2(compressInt,from,to),$Native$SecureRandom.getRandomInt({ctor: "_Tuple0"}));});
   var NoGetRandomValues = {ctor: "NoGetRandomValues"};
   return _elm.SecureRandom.values = {_op: _op,$int: $int,ints: ints,bool: bool,bools: bools,$float: $float,floats: floats};
};
Elm.Generator = Elm.Generator || {};
Elm.Generator.make = function (_elm) {
   "use strict";
   _elm.Generator = _elm.Generator || {};
   if (_elm.Generator.values) return _elm.Generator.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $SecureRandom = Elm.SecureRandom.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var generate = F2(function (dictionary,template) {
      var choose = function (arr) {
         return A2($Task.map,
         function (i) {
            return A2($Maybe.withDefault,"Failed to get word from dictionary",A2($Array.get,i,arr));
         },
         A2($Task.mapError,$Basics.toString,A2($SecureRandom.$int,0,$Array.length(arr))));
      };
      var getPosDict = function (pos) {
         var _p0 = pos;
         switch (_p0.ctor)
         {case "Noun": return function (_) {
                 return _.nouns;
              };
            case "Adjective": return function (_) {
                 return _.adjectives;
              };
            case "Verb": return function (_) {
                 return _.verbs;
              };
      ...
      var generateOne = function (part) {
         var _p1 = part;
         switch (_p1.ctor)
         {case "Verbatim": return $Task.succeed(_p1._0);
            case "Number": return A2($Task.map,$Basics.toString,A2($Task.mapError,$Basics.toString,A2($SecureRandom.$int,0,9)));
            default: return choose(A2(getPosDict,_p1._0,dictionary));}
      };
      return A2($Task.map,$String.concat,$Task.sequence(A2($List.map,generateOne,template)));
   });
   var Dictionary = F4(function (a,b,c,d) {    return {nouns: a,adjectives: b,verbs: c,adverbs: d};});
   var Word = function (a) {    return {ctor: "Word",_0: a};};
   var Number = {ctor: "Number"};
   var Verbatim = function (a) {    return {ctor: "Verbatim",_0: a};};
   var Adverb = {ctor: "Adverb"};
   var Verb = {ctor: "Verb"};
   var Adjective = {ctor: "Adjective"};
   var Noun = {ctor: "Noun"};
   return _elm.Generator.values = {_op: _op
                                  ,Noun: Noun
                                  ,Adjective: Adjective
                                  ,Verb: Verb
                                  ,Adverb: Adverb
...
Elm.Model.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var GenerationFinished = function (a) {    return {ctor: "GenerationFinished",_0: a};};
   var DictionaryLoadingFinished = function (a) {    return {ctor: "DictionaryLoadingFinished",_0: a};};
   var GenerateButtonClicked = {ctor: "GenerateButtonClicked"};
   var PasswordTemplateInput = function (a) {    return {ctor: "PasswordTemplateInput",_0: a};};
   var Model = F3(function (a,b,c) {    return {passwordTemplateInput: a,generatorDictionary: b,generatorOutput: c};});
   var Finished = function (a) {    return {ctor: "Finished",_0: a};};
   var Generating = {ctor: "Generating"};
   var LoadingDictionary = function (a) {    return {ctor: "LoadingDictionary",_0: a};};
   ...
   return _elm.Model.values = {_op: _op
                              ...
                              ,Finished: Finished
                              ,Model: Model
                              ,PasswordTemplateInput: PasswordTemplateInput
                              ,GenerateButtonClicked: GenerateButtonClicked
                              ,DictionaryLoadingFinished: DictionaryLoadingFinished
                              ,GenerationFinished: GenerationFinished};
};
Elm.TemplateParser = Elm.TemplateParser || {};
Elm.TemplateParser.make = function (_elm) {
   "use strict";
   _elm.TemplateParser = _elm.TemplateParser || {};
   if (_elm.TemplateParser.values) return _elm.TemplateParser.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Blueshift = Elm.Blueshift.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Generator = Elm.Generator.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var verbatimString = A2($Blueshift.map,
   function (_p0) {
      return $Generator.Verbatim($String.concat(A2($List.map,$String.fromChar,_p0)));
   },
   $Blueshift.some($Blueshift.notChar(_U.chr("{"))));
   var number = A2($Blueshift.map,$Basics.always($Generator.Number),$Blueshift.string("\\d"));
   var partOfSpeech = A2($Blueshift.annotate,
   A2($Blueshift.or,
   A2($Blueshift.or,
   A2($Blueshift.or,
   A2($Blueshift.combine,$Blueshift.string("noun"),$Blueshift.succeed($Generator.Noun)),
   A2($Blueshift.combine,$Blueshift.string("adj"),$Blueshift.succeed($Generator.Adjective))),
   A2($Blueshift.combine,$Blueshift.string("verb"),$Blueshift.succeed($Generator.Verb))),
   A2($Blueshift.combine,$Blueshift.string("adv"),$Blueshift.succeed($Generator.Adverb))),
   "a part of speech");
   var inCurlyBraces = function (p) {
      return A2($Blueshift.andThen,
      A2($Blueshift.annotate,$Blueshift.$char(_U.chr("{")),"a \'{\'"),
      function (_p1) {
         return A2($Blueshift.andThen,
         p,
         function (r) {
            return A2($Blueshift.combine,A2($Blueshift.annotate,$Blueshift.$char(_U.chr("}")),"a \'}\'"),$Blueshift.succeed(r));
         });
      });
   };
   var word = A2($Blueshift.map,$Generator.Word,inCurlyBraces(partOfSpeech));
   var templatePart = A2($Blueshift.or,A2($Blueshift.or,word,number),verbatimString);
   var template = A2($Blueshift.andThen,
   $Blueshift.many(templatePart),
   function (r) {
      return A2($Blueshift.andThen,$Blueshift.end,function (_p2) {    return $Blueshift.succeed(r);});
   });
   var parse = $Blueshift.parse(template);
   return _elm.TemplateParser.values = {_op: _op,parse: parse};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   var view = F2(function (addr,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,addr,$Model.GenerateButtonClicked)]),_U.list([$Html.text("Generate")]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$Html.text(function () {
                 var _p0 = model.generatorOutput;
                 switch (_p0.ctor)
                 {case "NotStarted": return "click the button to start generating...";
                    case "LoadingDictionary": return A2($Basics._op["++"],
                      "Loading dictionary, ",
                      A2($Basics._op["++"],$Basics.toString(_p0._0),"% complete..."));
                    case "Generating": return "generating...";
                    default: if (_p0._0.ctor === "Ok") {
                            return _p0._0._0;
                         } else {
                            return A2($Basics._op["++"],"Error: ",_p0._0._0);
                         }}
              }())]))
              ,A2($Html.input,
              _U.list([$Html$Attributes.placeholder("password template goes here")
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (x) {    return A2($Signal.message,addr,$Model.PasswordTemplateInput(x));})
                      ,$Html$Attributes.value(A2($Maybe.withDefault,"",model.passwordTemplateInput))]),
              _U.list([]))]));
   });
   return _elm.View.values = {_op: _op,view: view};
};
Elm.Pwdgen = Elm.Pwdgen || {};
Elm.Pwdgen.make = function (_elm) {
   "use strict";
   _elm.Pwdgen = _elm.Pwdgen || {};
   if (_elm.Pwdgen.values) return _elm.Pwdgen.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm),
   $TemplateParser = Elm.TemplateParser.make(_elm),
   $View = Elm.View.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      update: while (true) {
         var generate = function (dictionary) {
            return A3($Basics.flip,
            $Task.andThen,
            function (template) {
               return A2($Generator.generate,dictionary,template);
            },
            $Task.fromResult(A3($Basics.flip,
            $Result.andThen,
            function (_p0) {
               return A2($Result.formatError,
               F2(function (x,y) {    return A2($Basics._op["++"],x,y);})("Could not parse password template: "),
               $TemplateParser.parse(_p0));
            },
            A2($Maybe.withDefault,$Result.Err("Password template is empty"),A2($Maybe.map,$Result.Ok,model.passwordTemplateInput)))));
         };
         var loadDictionary = function (_p1) {
            var _p2 = _p1;
            var decodeField = function (name) {    return A2($Json$Decode.at,_U.list([name]),$Json$Decode.array($Json$Decode.string));};
            var decodeDict = A5($Json$Decode.object4,
         ...
         var _p3 = action;
         switch (_p3.ctor)
         {case "PasswordTemplateInput": return {ctor: "_Tuple2",_0: _U.update(model,{passwordTemplateInput: $Maybe.Just(_p3._0)}),_1: $Effects.none};
            case "GenerateButtonClicked": var work = function (_p4) {
                 var _p5 = _p4;
                 var _p6 = model.generatorDictionary;
                 if (_p6.ctor === "Just") {
                       return {ctor: "_Tuple2"
                              ,_0: _U.update(model,{generatorOutput: $Model.Generating})
                              ,_1: $Effects.task(A2($Task.map,$Model.GenerationFinished,$Task.toResult(generate(_p6._0))))};
                    } else {
                       return {ctor: "_Tuple2"
                              ,_0: _U.update(model,{generatorOutput: $Model.LoadingDictionary(0)})
                              ,_1: $Effects.task(A2($Task.map,
                              function (result) {
                                 var _p7 = result;
                                 if (_p7.ctor === "Ok") {
                                       return $Model.DictionaryLoadingFinished(_p7._0);
                                    } else {
                                       return $Model.GenerationFinished($Result.Err(_p7._0));
                                    }
                              },
                              $Task.toResult(loadDictionary({ctor: "_Tuple0"}))))};
                    }
              };
              var _p8 = model.generatorOutput;
              switch (_p8.ctor)
              {case "NotStarted": return work({ctor: "_Tuple0"});
                 case "Finished": return work({ctor: "_Tuple0"});
                 default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
            case "DictionaryLoadingFinished": var _v6 = $Model.GenerateButtonClicked,
              _v7 = _U.update(model,{generatorDictionary: $Maybe.Just(_p3._0),generatorOutput: $Model.NotStarted});
              action = _v6;
              model = _v7;
              continue update;
            default: return {ctor: "_Tuple2",_0: _U.update(model,{generatorOutput: $Model.Finished(_p3._0)}),_1: $Effects.none};}
      }
   });
   var initModel = {passwordTemplateInput: $Maybe.Just("{adj}{noun}\\d\\d"),generatorDictionary: $Maybe.Nothing,generatorOutput: $Model.NotStarted};
   var initAction = {ctor: "_Tuple2",_0: initModel,_1: $Effects.none};
   var app = $StartApp.start({init: initAction,update: update,view: $View.view,inputs: _U.list([])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.Pwdgen.values = {_op: _op,initModel: initModel,initAction: initAction,update: update,app: app,main: main};
};
